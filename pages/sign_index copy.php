<?php 
  ...
  $sql = "SELECT * FROM maintenance_record WHERE id = '?'";
  $accom = mysqli_query($con,$sql);
    $row = mysqli_num_rows($accom);
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../dist/css/jquery.signature.css">
                    ...
                    <div class="col-md-6">
                        ...
                        <form id="signatureForm">
                            <div class="form-group">
                                <label for="inputSignatureid">Name</label>
                                <input type="text" class="form-control" value="<?php echo $_GET['id'];?>" id="inputSignatureid" name="signatureid" required="">
...
<![endif]-->
        ...
        <script src="../plugins/jquery/jquery.signature.js"></script>
            ...
            $(function() {
                ...
                load:function(person_ID){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(data) {
                            $('#inputSignatureid').val(data.Name);
                            $('#inputTaskid').val(data.Name);
