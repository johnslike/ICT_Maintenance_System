...
if(isset($userdetails)){
  if($userdetails['access'] !="User"){
    ...
    if(isset($_POST['signaturesubmit'])){ 
        ...
        $sql = "INSERT INTO `employees_signature` (`signature`, mr_id) VALUES ('$signatureFileName','$id');";
                $query=mysqli_query($con,$sql);
    
        $msg = "<div class='alert alert-success'>Signature Uploaded</div>";

        echo header("Location: maintenance_add_task.php?id=$employee");
    } 
    ?>
    <html>
    <head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <br>
                    <a href="maintenance_add_task.php?id=<?php echo $tasks['employee_id'];?>" class="btn btn btn-secondary btn-lg"><i class = "fas fa-arrow-left"></i> Back</a>
                    <button type="button" class="btn btn btn-danger btn-lg" id="reset-btn"><i class = "fas fa-broom"></i> Clear</button>
                    <button type="button" class="btn btn btn-success btn-lg" id="btn-save"><i class = "fas fa-check"></i> Save</button>
                </div>
