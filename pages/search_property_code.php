          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <table id="table" class="table table-bordered text-nowrap">
                ...
                <!-- <td style="background-color:#ffe083;"><?php echo $row['action'];?></td> -->
                <!-- <td style="background-color:#ffe083;"><?php echo $row['reason'];?></td> -->
                <!-- <td style="background-color:#ffe083;"><?php echo date("M d, Y", strtotime($row['date_of_changestatus']));?></td> -->
                <td style="width: 10px"><a type="button" class="btn btn-info btn-sm" href="add_task_done.php?id=<?php echo $row['id']?>"><i class="fas fa-arrow-right"></i> Select</a></td>
